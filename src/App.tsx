...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            {
                path: "/quiz/:id/editor",
                element: <ProtectedRoute><QuizEditor /></ProtectedRoute>
            },
            {
                path: "/match/:id/lobby",
                element: <ProtectedRoute><MatchLobby /></ProtectedRoute>
            },
            {
                path: "/match/:id/play",
                element: <ProtectedRoute><MatchPlay /></ProtectedRoute>
            },
            {
                path: "/quiz",
                element: <ProtectedRoute><CreateQuizForm /></ProtectedRoute>
            },
            {
                path: "/statistics",
                element: <ProtectedRoute><UserStats /></ProtectedRoute>
            },
            {
                path: "/ai/generate",
                element: <ProtectedRoute><AIQuizGenerator /></ProtectedRoute>
            },
            {
                path: "/ai/review/:jobId",
                element: <ProtectedRoute><AIQuizReview /></ProtectedRoute>
            },
            {
                path: "/classrooms",
            ...
            {
                path: "/homework/:id/start",
                element: <ProtectedRoute><HomeworkStart /></ProtectedRoute>
            },
            {
            ...
            {
                path: "/billing/cancel",
                element: <ProtectedRoute><BillingCancel /></ProtectedRoute>
            },
            {
                path: "/home",
